...
def evaluate_bias_nli(model, args, eval_loader, output_dir, model_path):
    ...
    if args.eval_10:
        with open(os.path.join(output_dir, "bias_results_bias_nli_10percent.json"), "a") as f:
            json.dump(results, f)
            f.write('\n')
    else:
...
def main():
    ...
    parser.add_argument("--eval_10", action="store_true", help="eval only 10 percent of bias-nli data.")
    # parser.add_argument(
    #     "--load_from_file",
    #     type=str,
    #     default=None,
